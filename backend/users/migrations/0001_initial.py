# Generated by Django 6.0.6 on 2026-06-15 01:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sat_score', models.CharField(blank=True, max_length=10)),
                ('english_test', models.CharField(blank=True, max_length=50)),
                ('english_score', models.CharField(blank=True, max_length=20)),
                ('intended_degree', models.CharField(blank=True, max_length=50)),
                ('start_semester', models.CharField(blank=True, max_length=50)),
